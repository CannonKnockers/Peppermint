...
DAEMON_NAME = "org.minty.Daemon"
DAEMON_PATH = "/org/minty/Daemon"
DAEMON_IFACE = "org.minty.Daemon"

WINDOW_NAME = "org.minty.Window"
WINDOW_PATH = "/org/minty/Window"
WINDOW_IFACE = "org.minty.Window"

DAEMON_XML = """
<node>
  <interface name="org.minty.Daemon">
    <method name="AddTask">
...
WINDOW_XML = """
<node>
  <interface name="org.minty.Window">
    <method name="Toggle"/>
    <method name="Present"/>
    ...
    try:
        ...
        if "ServiceUnknown" in err.message or "was not provided" in err.message:
            raise DaemonNotRunning(
                f"`{name}` is not running. Start it with: systemctl --user start minty-daemon"
            ) from err
        raise
    return result
